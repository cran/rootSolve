...
@
The steady-state of this system of 5001 nonlinear equations is retrieved in but
a fraction of a second \footnote{on my computer that dates from 2005}.
...
@
Although this model consists of 2000 nonlinear equations, it takes less than a second to solve it.
...
It takes about 1 second to solve this 10000 state variable model.
